...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.dominorestwebclient=");
    idx += (13 + "dominorestwebclient".length);  // 
  }
  if (idx >= 0) {
...
//# sourceMappingURL=http://127.0.0.1:9876/sourcemaps/dominorestwebclient/_sourcemap.json 
//# sourceURL=dominorestwebclient-0.js
